...
///////////////////////////////////////////////////////////////////////////////
Matrix4x4::Matrix4x4(const Matrix2x2& M_11, const Matrix2x2& M_12, const Matrix2x2& M_21, const Matrix2x2& M_22)
{
	m(0, 0) = M_11(0, 0);
	m(0, 1) = M_11(0, 1);
	m(1, 0) = M_11(1, 0);
...
///////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::SetZeroMatrix()
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4x4& Matrix4x4::SetIdentityMatrix()
{
	SetZeroMatrix();
...
///////////////////////////////////////////////////////////////////////////////
const float& Matrix4x4::operator()(const int row_index, const int col_index) const
{
	return m(row_index, col_index);
}

///////////////////////////////////////////////////////////////////////////////
float& Matrix4x4::operator()(const int row_index, const int col_index)
{
	return m(row_index, col_index);
}
...
///////////////////////////////////////////////////////////////////////////////
bool Matrix4x4::IsApproximatelyEqual(const Matrix4x4& other, const float epsilon) const
{
	for (int i = 0; i < 4; ++i)
	{
		for (int j = 0; j < 4; ++j)
...
///////////////////////////////////////////////////////////////////////////////
Matrix4x4 Matrix4x4::NaiveMatrixProduct(const Matrix4x4& A, const Matrix4x4& B)
{
	Matrix4x4 result;
...
///////////////////////////////////////////////////////////////////////////////
Matrix4x4 Matrix4x4::StrassenMatrixProduct(const Matrix4x4& A, const Matrix4x4& B)
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix3x3 Matrix4x4::Submatrix(int skip_row_index, int skip_col_index) const
{
...
///////////////////////////////////////////////////////////////////////////////
const float& Matrix4x4::m(const int row_index, const int col_index) const
{
...
///////////////////////////////////////////////////////////////////////////////
float& Matrix4x4::m(const int row_index, const int col_index)
{
	assert(row_index >= 0 && row_index < 4);
	assert(col_index >= 0 && col_index < 4);
